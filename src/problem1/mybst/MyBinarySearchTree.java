...
public class MyBinarySearchTree {
    ...
    public void insert(int data)
    {
        ...
        if(root == null)
        {
            root = node;
            size++;
            System.out.println("Successfully Inserted at root.");
        }
        else
        {
            TreeNode temp = root;
            ...
            else
            {
                ...
                size++;
                System.out.println("Successfully Inserted at right");
            }
        }
    }
    ...
    public void traverseLevelOrder(TreeNode node){
        ...
        System.out.println();
        System.out.println("Number of nodes who don't have left node: "+count);
    }
}
